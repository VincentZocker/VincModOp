...
public class SampleItem extends Item {
    ...
    public ActionResult<ItemStack> onItemRightClick(World worldIn, PlayerEntity playerIn, Hand handIn) {
        EntityRayTraceResult entityraytraceresult = ProjectileHelper.rayTraceEntities(worldIn, playerIn., playerIn.getEyePosition(1), playerIn.getEyePosition(1).add(playerIn.getLook(1.0F).x * 32, playerIn.getLook(1.0F).y * 32, playerIn.getLook(1.0F).z * 32), playerIn.getBoundingBox().expand(playerIn.getLook(1.0F).scale(32)), (p_215312_0_) -> {
